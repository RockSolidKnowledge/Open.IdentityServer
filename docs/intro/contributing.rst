...
Submitted code should be human-authored and not originate from any other proprietary source.  Please see the `contribution guidelines <https://github.com/RockSolidKnowledge/Open.IdentityServer/blob/main/CONTRIBUTING.md>`_` in the GitHub repo.
