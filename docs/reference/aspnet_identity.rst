...
The repo for this support is located `here <https://github.com/RockSolidKnowledge/Open.IdentityServer.AspNetIdentity/>`_ and the NuGet package is `here <https://www.nuget.org/packages/Open.IdentityServer.AspNetIdentity>`_.
