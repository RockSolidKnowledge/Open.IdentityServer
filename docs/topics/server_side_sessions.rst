...
Open.IdentityServer Server-Side Sessions solves these issues by storing the contents of this cookie in a server side data store. This enables in Open.IdentityServer the ability to:
