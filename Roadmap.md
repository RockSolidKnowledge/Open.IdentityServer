...
Features may be delivered as part of the core open-source project or as separately licenced components available on [IdentityServer.com](https://www.identityserver.com/products).
...
We welcome community input on the roadmap. If you'd like to propose a feature or upvote an existing item:

1. Open a [GitHub Issue](link-to-issues) to suggest a feature or report a bug
2. Join the discussion on existing roadmap issues
3. Submit a pull request for items marked as open for contribution
