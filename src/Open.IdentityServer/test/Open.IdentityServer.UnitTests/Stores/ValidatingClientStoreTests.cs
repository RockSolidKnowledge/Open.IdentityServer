...
public class ValidatingClientStoreTests
{
    ...
    [Fact]
    public async Task FindClientById_WhenCalled_ShouldTelemetryTrace()
    {
        ...
        await subject.FindClientByIdAsync("client");
        
        _telemetry.Verify(
            t => t.Trace(
                TelemetryConstants.TraceCategories.Stores, subject, "FindClientByIdAsync"));
